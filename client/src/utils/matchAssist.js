...
export const getLocationMatchType = (lostLocation, foundLocation) => {
...
export const isLocationMatch = (lostLocation, foundLocation) =>
  getLocationMatchType(lostLocation, foundLocation) !== 'none';

export const getDayGap = (dateLost, dateFound) => {
...
export const buildPairKey = (lostItemId, foundItemId) =>
...
export const meetsThreshold = (result, threshold) =>
  result && result.score >= threshold;

export const isDisplayable = (result) =>
  meetsThreshold(result, MATCH_RULES.DISPLAY_THRESHOLD);

export const isHighScore = (result) =>
...
export const findMatchesForLost = (lostItem, foundItems, options = {}) => {
...
export const findMatchesForFound = (foundItem, lostItems, options = {}) => {
...
export const findHighScorePairs = (lostItems, foundItems) => {
